                ...
                if (bullets.get(j).bulletHealth > 0) {
                    ...
                    for (int k = 0; k < omenoctEnemies.size(); k++) {
                        if (omenoctEnemies.get(k).enemyHealth > 0) {
                            ...
                            double xMin2 = omenoctEnemies.get(k).x - AllEnemies.OmenoctModel.distanceToCenter;
                            double xMax2 = omenoctEnemies.get(k).x + AllEnemies.OmenoctModel.distanceToCenter;
                            double yMin2 = omenoctEnemies.get(k).y;
                            double yMax2 = omenoctEnemies.get(k).y + (2* AllEnemies.OmenoctModel.distanceToCenter);
                            ...
                            if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                                ...
                                Impact.turnOnImpact(bullets.get(j).x + ((double) BulletModel.bulletSize / 2),
                                        ...
                                        omenoctEnemies.get(k).x + ((double) AllEnemies.OmenoctModel.omenoctSize),
                                        omenoctEnemies.get(k).y + ((double) AllEnemies.OmenoctModel.omenoctSize));
                ...
                if (bullets.get(j).bulletHealth > 0) {
                    ...
                    for (int k = 0; k < necropickEnemies.size(); k++) {
                        if (necropickEnemies.get(k).enemyHealth > 0) {
                            ...
                            double xMax2 = necropickEnemies.get(k).x + AllEnemies.NecropickModel.necropickSize;
                            double yMin2 = necropickEnemies.get(k).y;
                            double yMax2 = necropickEnemies.get(k).y + AllEnemies.NecropickModel.necropickSize;
                            ...
                            if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                                ...
                                Impact.turnOnImpact(bullets.get(j).x + ((double) BulletModel.bulletSize / 2),
                                        bullets.get(j).y + ((double) BulletModel.bulletSize / 2),
                                        necropickEnemies.get(k).x + ((double) AllEnemies.NecropickModel.necropickSize),
                                        necropickEnemies.get(k).y + ((double) AllEnemies.NecropickModel.necropickSize));
                ...
                if (bullets.get(j).bulletHealth > 0) {
                    ...
                    for (int k = 0; k < archmireEnemies.size(); k++) {
                        if (archmireEnemies.get(k).enemyHealth > 0) {
                            ...
                            double xMax2 = archmireEnemies.get(k).x + AllEnemies.ArchmireModel.archmireSize;
                            double yMin2 = archmireEnemies.get(k).y;
                            double yMax2 = archmireEnemies.get(k).y + AllEnemies.ArchmireModel.archmireSize;
                ...
                if (bullets.get(j).bulletHealth > 0) {
                    ...
                    for (int k = 0; k < wyrmEnemies.size(); k++) {
                        if (wyrmEnemies.get(k).enemyHealth > 0) {
                            ...
                            double xMax2 = wyrmEnemies.get(k).x + AllEnemies.WyrmModel.wyrmSize;
                            double yMin2 = wyrmEnemies.get(k).y;
                            double yMax2 = wyrmEnemies.get(k).y + AllEnemies.WyrmModel.wyrmSize;
                            ...
                            if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                                ...
                                Impact.turnOnImpact(bullets.get(j).x + ((double) BulletModel.bulletSize / 2),
                                        bullets.get(j).y + ((double) BulletModel.bulletSize / 2),
                                        wyrmEnemies.get(k).x + ((double) AllEnemies.WyrmModel.wyrmSize / 2),
                                        wyrmEnemies.get(k).y + ((double) AllEnemies.WyrmModel.wyrmSize / 2));
                ...
                if (bullets.get(j).bulletHealth > 0) {
                    ...
                    for (int k = 0; k < barricadosEnemies1.size(); k++) {
                        if (barricadosEnemies1.get(k).enemyTimer > 0) {
                            ...
                            double xMax2 = barricadosEnemies1.get(k).x + AllEnemies.BarricadosModel1.barricadosSize;
                            double yMin2 = barricadosEnemies1.get(k).y;
                            double yMax2 = barricadosEnemies1.get(k).y + AllEnemies.BarricadosModel1.barricadosSize;
                            ...
                            if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                                ...
                                Impact.turnOnImpact(bullets.get(j).x + ((double) BulletModel.bulletSize / 2),
                                        bullets.get(j).y + ((double) BulletModel.bulletSize / 2),
                                        barricadosEnemies1.get(k).x + ((double) AllEnemies.BarricadosModel1.barricadosSize / 2),
                                        barricadosEnemies1.get(k).y + ((double) AllEnemies.BarricadosModel1.barricadosSize / 2));
                ...
                if (bullets.get(j).bulletHealth > 0) {
                    ...
                    for (int k = 0; k < barricadosEnemies2.size(); k++) {
                        if (barricadosEnemies2.get(k).enemyTimer > 0) {
                            ...
                            double xMax2 = barricadosEnemies2.get(k).x + AllEnemies.BarricadosModel2.barricadosSize;
                            double yMin2 = barricadosEnemies2.get(k).y;
                            double yMax2 = barricadosEnemies2.get(k).y + AllEnemies.BarricadosModel2.barricadosSize;
                            ...
                            if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                                ...
                                Impact.turnOnImpact(bullets.get(j).x + ((double) BulletModel.bulletSize / 2),
                                        bullets.get(j).y + ((double) BulletModel.bulletSize / 2),
                                        barricadosEnemies2.get(k).x + ((double) AllEnemies.BarricadosModel2.barricadosSize / 2),
                                        barricadosEnemies2.get(k).y + ((double) AllEnemies.BarricadosModel2.barricadosSize / 2));
                ...
                if (bullets.get(j).bulletHealth > 0) {
                    ...
                    for (int k = 0; k < blackOrbEnemies.size(); k++) {
                        if (blackOrbEnemies.get(k).enemyHealth > 0) {
                            ...
                            double xMax2 = blackOrbEnemies.get(k).x + AllEnemies.BlackOrbModel.blackOrbSize;
                            double yMin2 = blackOrbEnemies.get(k).y;
                            double yMax2 = blackOrbEnemies.get(k).y + AllEnemies.BlackOrbModel.blackOrbSize;
                            ...
                            if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                                ...
                                Impact.turnOnImpact(bullets.get(j).x + ((double) BulletModel.bulletSize / 2),
                                        bullets.get(j).y + ((double) BulletModel.bulletSize / 2),
                                        blackOrbEnemies.get(k).x + ((double) AllEnemies.BlackOrbModel.blackOrbSize / 2),
                                        blackOrbEnemies.get(k).y + ((double) AllEnemies.BlackOrbModel.blackOrbSize / 2));
        ...
        if (!archmirePoints.isEmpty()) {
            ...
            for (int k = 0; k < size; k++) {
                if (archmirePoints.get(k).archmirePointTimer > 0) {
                    ...
                    double xMax2 = archmirePoints.get(k).x + AllEnemies.ArchmireModel.archmireSize;
                    double yMin2 = archmirePoints.get(k).y;
                    double yMax2 = archmirePoints.get(k).y + AllEnemies.ArchmireModel.archmireSize;
            ...
            for (int k = 0; k < necropickEnemies.size(); k++) {
                if (necropickEnemies.get(k).enemyHealth > 0 && !necropickEnemies.get(k).hide) {
                    ...
                    if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                        ...
                        Impact.turnOnImpact(GameController.ball.x,
                                GameController.ball.y,
                                necropickEnemies.get(k).x + ((double) AllEnemies.NecropickModel.necropickSize / 2),
                                necropickEnemies.get(k).y + ((double) AllEnemies.NecropickModel.necropickSize / 2));
        ...
        if (!wyrmEnemies.isEmpty()) {
            for (int i = 0; i < wyrmEnemies.size(); i++) {
                if (wyrmEnemies.get(i).enemyHealth > 0) {
                    ...
                    double xMax1 = wyrmEnemies.get(i).x + AllEnemies.WyrmModel.wyrmSize;
                    double yMin1 = wyrmEnemies.get(i).y;
                    double yMax1 = wyrmEnemies.get(i).y + AllEnemies.WyrmModel.wyrmSize;
                    ...
                    for (int k = 0; k < omenoctEnemies.size(); k++) {
                        if (omenoctEnemies.get(k).enemyHealth > 0) {
                            ...
                            if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                                ...
                                Impact.turnOnImpact(wyrmEnemies.get(i).x + ((double) AllEnemies.WyrmModel.wyrmSize / 2),
                                        wyrmEnemies.get(i).y + ((double) AllEnemies.WyrmModel.wyrmSize / 2),
                                        omenoctEnemies.get(k).x,
                                        omenoctEnemies.get(k).y + AllEnemies.OmenoctModel.distanceToCenter);
                            }
                        }
                    }
                }
                ...
                for (int k = 0; k < omenoctEnemies.size(); k++) {
                    if (omenoctEnemies.get(k).enemyHealth > 0) {
                        ...
                        if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                            ...
                            Impact.turnOnImpact(necropickEnemies.get(i).x + ((double) AllEnemies.NecropickModel.necropickSize / 2),
                                    necropickEnemies.get(i).y + ((double) AllEnemies.NecropickModel.necropickSize / 2),
                                    omenoctEnemies.get(k).x,
                                    omenoctEnemies.get(k).y + AllEnemies.OmenoctModel.distanceToCenter);
                        }
                    }
        ...
        if (!barricadosEnemies1.isEmpty()) {
            for (int i = 0; i < barricadosEnemies1.size(); i++) {
                if (barricadosEnemies1.get(i).enemyTimer > 0) {
                    ...
                    double xMax1 = barricadosEnemies1.get(i).x + AllEnemies.BarricadosModel1.barricadosSize;
                    double yMin1 = barricadosEnemies1.get(i).y;
                    double yMax1 = barricadosEnemies1.get(i).y + AllEnemies.BarricadosModel1.barricadosSize;
                    ...
                    for (int k = 0; k < omenoctEnemies.size(); k++) {
                        if (omenoctEnemies.get(k).enemyHealth > 0) {
                            ...
                            if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                                ...
                                Impact.turnOnImpact(barricadosEnemies1.get(i).x + ((double) AllEnemies.BarricadosModel1.barricadosSize / 2),
                                        barricadosEnemies1.get(i).y + ((double) AllEnemies.BarricadosModel1.barricadosSize / 2),
                                        omenoctEnemies.get(k).x,
                                        omenoctEnemies.get(k).y + AllEnemies.OmenoctModel.distanceToCenter);
                            }
                        }
        ...
        if (!barricadosEnemies2.isEmpty()) {
            for (int i = 0; i < barricadosEnemies2.size(); i++) {
                if (barricadosEnemies2.get(i).enemyTimer > 0) {
                    ...
                    double xMax1 = barricadosEnemies2.get(i).x + AllEnemies.BarricadosModel2.barricadosSize;
                    double yMin1 = barricadosEnemies2.get(i).y;
                    double yMax1 = barricadosEnemies2.get(i).y + AllEnemies.BarricadosModel2.barricadosSize;
                    ...
                    for (int k = 0; k < omenoctEnemies.size(); k++) {
                        if (omenoctEnemies.get(k).enemyHealth > 0) {
                            ...
                            if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                                ...
                                Impact.turnOnImpact(barricadosEnemies2.get(i).x + ((double) AllEnemies.BarricadosModel2.barricadosSize / 2),
                                        barricadosEnemies2.get(i).y + ((double) AllEnemies.BarricadosModel2.barricadosSize / 2),
                                        omenoctEnemies.get(k).x,
                                        omenoctEnemies.get(k).y + AllEnemies.OmenoctModel.distanceToCenter);
                            }
                        }
                    ...
                    if (!wyrmEnemies.isEmpty()) {
                        for (int j = 0; j < wyrmEnemies.size(); j++) {
                            if (wyrmEnemies.get(j).enemyHealth > 0) {
                                ...
                                double xMax2 = wyrmEnemies.get(j).x + AllEnemies.WyrmModel.wyrmSize;
                                double yMin2 = wyrmEnemies.get(j).y;
                                double yMax2 = wyrmEnemies.get(j).y + AllEnemies.WyrmModel.wyrmSize;
                                ...
                                if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                                    ...
                                    Impact.turnOnImpact(necropickEnemies.get(j).x + ((double) AllEnemies.NecropickModel.necropickSize / 2),
                                            necropickEnemies.get(j).y + ((double) AllEnemies.NecropickModel.necropickSize / 2),
                                            wyrmEnemies.get(j).x,
                                            wyrmEnemies.get(j).y + (double) AllEnemies.WyrmModel.wyrmSize / 2);
                                }
                            }
                        }
                    }
                        ...
                        for (int j = 0; j < necropickEnemies.size(); j++) {
                            if (necropickEnemies.get(j).enemyHealth > 0 && !necropickEnemies.get(j).hide) {
                                ...
                                if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                                    ...
                                    Impact.turnOnImpact(barricadosEnemies1.get(j).x + ((double) AllEnemies.BarricadosModel1.barricadosSize / 2),
                                            barricadosEnemies1.get(j).y + ((double) AllEnemies.BarricadosModel1.barricadosSize / 2),
                                            necropickEnemies.get(j).x + (double) AllEnemies.NecropickModel.necropickSize / 2,
                                            necropickEnemies.get(j).y + (double) AllEnemies.NecropickModel.necropickSize / 2);
                                }
                            }
                        }
                        ...
                        for (int j = 0; j < necropickEnemies.size(); j++) {
                            if (necropickEnemies.get(j).enemyHealth > 0 && !necropickEnemies.get(j).hide) {
                                ...
                                if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                                    ...
                                    Impact.turnOnImpact(barricadosEnemies2.get(j).x + ((double) AllEnemies.BarricadosModel2.barricadosSize / 2),
                                            barricadosEnemies2.get(j).y + ((double) AllEnemies.BarricadosModel2.barricadosSize / 2),
                                            necropickEnemies.get(j).x + (double) AllEnemies.NecropickModel.necropickSize / 2,
                                            necropickEnemies.get(j).y + (double) AllEnemies.NecropickModel.necropickSize / 2);
                                }
                            }
                        ...
                        for (int j = 0; j < wyrmEnemies.size(); j++) {
                            if (wyrmEnemies.get(j).enemyHealth > 0) {
                                ...
                                if (((xMin1 >= xMin2 && xMin1 <= xMax2) && (yMin1 >= yMin2 && yMin1 <= yMax2))
                                    ...
                                    Impact.turnOnImpact(barricadosEnemies2.get(i).x + ((double) AllEnemies.BarricadosModel2.barricadosSize / 2),
                                            barricadosEnemies2.get(i).y + ((double) AllEnemies.BarricadosModel2.barricadosSize / 2),
                                            wyrmEnemies.get(j).x + (double) AllEnemies.WyrmModel.wyrmSize / 2,
                                            wyrmEnemies.get(j).y + (double) AllEnemies.WyrmModel.wyrmSize / 2);
                                }
                            }
                        }
